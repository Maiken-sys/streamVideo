...
public class Broker {
    ...
    private LinkedBlockingQueue<Consumer> registeredConsumers = new LinkedBlockingQueue<Consumer>();
    private LinkedBlockingQueue<Publisher> registeredPublishers = new LinkedBlockingQueue<Publisher>();
    private LinkedBlockingQueue<ArrayList<Value>> videos = new LinkedBlockingQueue<ArrayList<Value>>();
