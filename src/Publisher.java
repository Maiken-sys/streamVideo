...
public class Publisher {
    ...
    public void initialize_structures(){
        try {
            ...
            new Connection(broker.getIp(), broker.getPort(), videos, true).start();
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public void notifyBrokers(String s, Value videoFile, boolean delete) {
        try{
            ...
            Thread t = new Connection(broker.getIp(), broker.getPort(), videos, videoFile, delete);
            t.start();
            threads.add(t);
        }catch (Exception e){
            e.printStackTrace();
    ...
    private class Connection extends Thread{
        ...
        public Connection(String ip, int port, LinkedBlockingQueue<Value> videos, Value videoFile, boolean delete){
            this.ip = ip;
            this.port = port;
            this.videos = videos;
            this.delete = delete;
        ...
        public Connection(String ip, int port, LinkedBlockingQueue<Value> videos, boolean init){
            this.ip = ip;
            this.port = port;
            this.videos = videos;
            this.init = init;
